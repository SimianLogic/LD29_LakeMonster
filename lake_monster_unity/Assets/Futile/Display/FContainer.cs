...
public class FContainer : FNode
{
	...
	public virtual int IndexOf(FNode node)
	{
		return _childNodes.IndexOf(node);
	}
	
	public virtual void AddChild(FNode node)
	{
	...
	public virtual void AddChildAtIndex(FNode node, int newIndex)
	{
		int nodeIndex = _childNodes.IndexOf(node);
	...
	public virtual void RemoveChild(FNode node)
	{
	...
	public virtual FNode GetChildAt(int childIndex)
	{
