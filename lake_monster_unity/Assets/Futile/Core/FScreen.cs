...
public class FScreen
{
	...
	// Added as convenience accessors to allow for aspect ratio behavior. - JM Jan 2014
	public float widescreenWidth;
	public float widescreenHeight;

	public float widescreenHalfWidth;
	public float widescreenHalfHeight;
	...
	public FScreen (FutileParams futileParams)
	{
		...
		widescreenHeight = height;
		widescreenWidth = height * 9f / 16f;

		widescreenHalfWidth = widescreenWidth / 2f;
		widescreenHalfHeight = widescreenHeight / 2f;
